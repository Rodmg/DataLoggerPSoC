...
export LoadConfig_rtc
export _LoadConfig_rtc
...
export Port_0_DriveMode_2_SHADE
export _Port_0_DriveMode_2_SHADE
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_DriveMode_0_SHADE], 4h
	mov		[Port_0_DriveMode_1_SHADE], fbh
	mov		[Port_0_DriveMode_2_SHADE], b8h
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], ffh
	mov		[Port_2_DriveMode_1_SHADE], 0h

	lcall	LoadConfig_rtc
	lcall	LoadConfigTBL_rtc_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration rtc
;
;    Load configuration registers for rtc.
...
_LoadConfig_rtc:
 LoadConfig_rtc:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_rtc_Bank0
    mov     X, <LoadConfigTBL_rtc_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_rtc_Bank1
    mov     X, <LoadConfigTBL_rtc_Bank1
...
_Port_0_DriveMode_2_SHADE:
Port_0_DriveMode_2_SHADE:	BLK	1
