...
export LoadConfigTBL_rtc_Bank1
export LoadConfigTBL_rtc_Bank0
export LoadConfigTBL_rtc_Ordered
AREA lit(rom, rel)
LoadConfigTBL_rtc_Bank0:
...
;       Instance name PGA, Block Name GAIN(ACB02)
	db		79h, d6h		;PGA_GAIN_CR0(ACB02CR0)
...
;       Instance name TempBuf, Block Name DigBuf(DBB01)
	...
	db		25h, 00h		;TempBuf_DATA_1_REG(DBB01DR1)
	db		26h, 00h		;TempBuf_DATA_2_REG(DBB01DR2)
...
;  Global Register values Bank 1
	...
	db		60h, 10h		; AnalogColumnClockSelect register (CLK_CR0)
	...
	db		d3h, 80h		; GlobalDigitalInterconnect_Drive_Even_Output register (GDI_E_OU)
